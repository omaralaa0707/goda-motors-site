...
export const en: GodaContent = {
  ...
  footer: {
    disclaimer: "A concept design, built as a demonstration. Not an official Goda Motors site, and not affiliated with them. All photography, marks and quoted copy belong to Goda Motors.",
